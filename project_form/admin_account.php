<?php
	...
	if(isset($_POST["submit"])){
		if(empty($_POST["adminname"])){
			$hasError = true;
			$err_adminname="Name Required";
		}
		else if(strlen($_POST["adminname"]) <= 2){
			$hasError = true;
		...
		if(empty($_POST["adminid"])){
			$hasError = true;
			$err_adminid="Id Required";
		}
		else if(strlen($_POST["adminid"]) <= 6){
			$hasError = true;
			$err_adminid="Id must contain >8 character";
		}
		else{
			$id = $_POST["adminid"];
		}
...
?>
<html>
	<head><title><?php echo"Admin Account";?></title></head>
	<body>
		...
		?>
			<table>
				<tr>
					<td>Admin Name</td>
					<td>: <input type="text" name="adminname" value="<?php echo $adminname; ?>" placeholder="Enter Admin Name "> </td>
					<td><span> <?php echo $err_adminname;?> </span></td>
				</tr>
				<tr>
					<td>Admin Id</td>
